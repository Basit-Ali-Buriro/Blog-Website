    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex justify-between items-center">
            <Link href="/" className="flex items-center gap-2">
              <div className="w-8 h-8 sm:w-10 sm:h-10 gradient-blue rounded-xl flex items-center justify-center">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                </svg>
              </div>
              <span className="text-lg sm:text-xl font-bold text-gray-900">BlogSpace</span>
            </Link>
            <div className="flex items-center gap-1 sm:gap-3">
              <Link
                href="/posts"
                className="hidden sm:inline-block text-gray-600 hover:text-gray-900 font-medium px-3 sm:px-4 py-2 rounded-lg hover:bg-gray-100 transition-all text-sm sm:text-base"
              >
                Explore
              </Link>
              {session ? (
                <>
                  ...
                  <Link
                    ...
                    className="gradient-blue text-white px-3 sm:px-5 py-1.5 sm:py-2 rounded-lg font-semibold hover:opacity-90 transition-all text-sm sm:text-base"
                  >
                ...
                <>
                  <Link
                    href="/auth/login"
                    className="text-gray-600 hover:text-gray-900 font-medium px-2 sm:px-4 py-1.5 sm:py-2 rounded-lg hover:bg-gray-100 transition-all text-sm sm:text-base"
                  >
                    Sign In
                  </Link>
                  <Link
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-24 md:py-32 relative">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-purple-100 text-purple-700 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-medium mb-4 sm:mb-6">
              ...
              <span className="hidden xs:inline">Welcome to the future of blogging</span>
              <span className="xs:hidden">Future of blogging</span>
            </div>

            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-gray-900 mb-4 sm:mb-6 leading-tight animate-fade-in">
              Where Ideas Come
              <span className="block gradient-blue bg-clip-text text-white rounded-2xl mt-2">To Life</span>
            </h1>

            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 mb-6 sm:mb-10 max-w-2xl mx-auto leading-relaxed px-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
              <Link
                href="/auth/signup"
                className="gradient-blue text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg hover:opacity-90 transition-all transform hover:scale-105 shadow-xl shadow-purple-500/30 flex items-center justify-center gap-2"
              >
                <span className="hidden sm:inline">Start Writing Free</span>
              ...
              <Link
                href="/posts"
                className="bg-gray-100 text-gray-900 px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg hover:bg-gray-200 transition-all flex items-center justify-center gap-2"
              >
                <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Stats */}
            <div className="grid grid-cols-3 gap-4 sm:gap-8 md:gap-12 mt-8 sm:mt-12 md:mt-16 pt-8 sm:pt-12 border-t border-gray-200 px-4">
              <div className="text-center">
                <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">10K+</p>
                <p className="text-gray-600 mt-1 text-xs sm:text-sm md:text-base">Active Writers</p>
              </div>
              <div className="text-center">
                <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">50K+</p>
                <p className="text-gray-600 mt-1 text-xs sm:text-sm md:text-base">Published Posts</p>
              </div>
              <div className="text-center">
                <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">1M+</p>
                <p className="text-gray-600 mt-1 text-xs sm:text-sm md:text-base">Monthly Readers</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-gray-50 py-12 sm:py-16 md:py-20 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8 sm:mb-12 md:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 sm:mb-4">Why Choose BlogSpace?</h2>
            <p className="text-gray-600 text-sm sm:text-base md:text-lg max-w-2xl mx-auto px-4">Everything you need to create, publish, and grow your audience</p>
          </div>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end mb-8 sm:mb-12 gap-4">
          <div>
            <span className="text-purple-600 font-semibold text-xs sm:text-sm uppercase tracking-wider">Fresh Content</span>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mt-2">Latest Posts</h2>
            <p className="text-gray-600 mt-2 sm:mt-3 text-sm sm:text-base">Discover what our community is writing about</p>
          </div>
          <Link
            href="/posts"
            className="inline-flex sm:hidden md:flex items-center gap-2 text-purple-600 font-semibold hover:text-purple-700 transition-colors text-sm sm:text-base"
          >
            View All
            <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {posts.map((post, index) => (
                <Link href={`/posts/${post._id}`} key={post._id}>
                  <article className="group bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer h-full">
                    {/* Post Image */}
                    <div className={`h-52 flex items-center justify-center relative overflow-hidden ${index % 3 === 0 ? 'gradient-blue' :
      ...
      {/* CTA Section */}
      <section className="relative overflow-hidden">
        <div className="gradient-blue py-12 sm:py-16 md:py-20 px-4 sm:px-6">
          ...
          <div className="max-w-4xl mx-auto text-center relative">
            ...
            <p className="text-white/90 mb-6 sm:mb-10 text-base sm:text-lg md:text-xl max-w-2xl mx-auto px-4">
              Join our community of passionate writers and start your blogging journey today. It&apos;s free to get started!
            </p>
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
              <Link
                href="/auth/signup"
                className="bg-white text-purple-600 px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-bold text-base sm:text-lg hover:bg-gray-100 transition-all transform hover:scale-105 shadow-xl flex items-center justify-center gap-2"
              >
                Create Free Account
                <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
              ...
              <Link
                href="/auth/login"
                className="bg-transparent border-2 border-white text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-bold text-base sm:text-lg hover:bg-white hover:text-purple-600 transition-all"
              >
                Sign In
              </Link>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 sm:gap-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg sm:text-xl font-bold text-white">BlogSpace</span>
            </div>
            ...
            <p className="text-xs sm:text-sm">© 2026 BlogSpace. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
